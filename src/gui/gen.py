...
class Ui_designer_window(object):
    def setupUi(self, designer_window):
        ...
        self.gridLayout.addWidget(self.line_test, 0, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.btn_browse_test, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.line_ref, 1, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.btn_browse_ref, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_export, 2, 5, 1, 1)
    ...
    def retranslateUi(self, designer_window):
        ...
        self.btn_export.setText(_translate("designer_window", "Export"))
        self.btn_clear.setText(_translate("designer_window", "Clear"))
